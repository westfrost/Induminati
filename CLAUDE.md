...
**File:** `/home/user/Induminati/Opskæring/index.html` (single self-contained file, ~1590 lines: inline `<style>` + inline `<script>`, plus `xlsx.full.min.js` (SheetJS 0.18.5, CDN) for reading the optional stock-list upload — otherwise no external deps besides Google Fonts). Current version: **v3.5 · 15-09-2026** (footer at line 1587).
...
**v3.5 · 15-09-2026** (footer, line 1587: `Opskæringsberegner · v3.5 · 15-09-2026`).
